<?php
  ...
  $query = "SELECT *
            FROM cart
            WHERE cart_sess = '$sessid'";

  $results = mysqli_query($connect, $query) or die (mysql_query());

  if(mysqli_num_rows($results)==0){
    echo "<br><br><br><div style=\"width:200px; margin:auto;\">Your Cart is empty</div> ";
  }
  else{
?>
<br><br><br>
<table border="1" align="center" cellpadding="5">
  ...
  echo "</td></tr>";
  echo "</table><br>";
  echo "<div style=\"width:350px; margin:auto;\">You currently have " .$totalquantity
    . " product(s) selected in your cart.</div> ";
  ?>
